      ...
      {(activeViewRole === "admin" || activeViewRole === "coach" || user?.realRole === "admin") && !user?.isImpersonating && (
        <div className="fixed bottom-24 right-4 z-40" data-tour="create-post">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.92 }}
            className="relative w-14 h-14 rounded-full bg-[var(--brand-primary)] hover:bg-[var(--brand-primary-dark)] text-white shadow-xl flex items-center justify-center cursor-grab active:cursor-grabbing select-none border-4 border-gray-900 dark:border-white"
