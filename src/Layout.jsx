...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="flex flex-col bg-gradient-to-br from-[var(--brand-secondary)] to-[var(--brand-secondary-light)] dark:from-[#111] dark:to-[#111]" style={{ minHeight: '100dvh', paddingTop: 'env(safe-area-inset-top)' }}>
      {/* Top Bar */}
