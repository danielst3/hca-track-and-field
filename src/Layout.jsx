...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-gradient-to-br from-[var(--brand-secondary)] to-[var(--brand-secondary-light)] dark:from-[#111] dark:to-[#111]" style={{ paddingTop: "env(safe-area-inset-top)" }}>
      ...
      {/* Bottom Navigation */}
      <div ref={navRef} className="bg-white dark:bg-gray-900 border-t border-slate-200 dark:border-gray-700 shadow-lg z-50 select-none flex-shrink-0" style={{ paddingBottom: 'env(safe-area-inset-bottom, 16px)' }}>
